            ...
            <ContactBox generalTheme={theme} >
                <ContactContent >
                    ...
                    <form id="contactInformation">
                        ...
                        <ContactLabel generalTheme={theme} gridColumn={"2/3"} gridRow={"1/2"} gridC={"1/2"} gridR={"5/6"} >Description</ContactLabel>
            ...
            <ContactBox generalTheme={theme} >
                <ContactContent >
                    ...
                    <form id="contactInformation">
                        ...
                        <ContactTextBox gridColumn={"1/2"} gridRow={"4/5"}/>
                        <ContactLabel generalTheme={theme} gridColumn={"2/3"} gridRow={"1/2"} gridC={"1/2"} gridR={"5/6"} >Descripción</ContactLabel>
                        <ContactTextArea id="contactArea"/>
